...
def buscar_nombre(parte_nombre):
    ...
    try:
        with conn.cursor() as cursor:
            cursor.execute("SELECT Titulo FROM Video WHERE Titulo LIKE %s", ('%{}%'.format(parte_nombre),))
...
def buscar_titulo():
    ...
    print("El titulo del esclavo2: ",titulo)
    if titulo:
...
def buscar_tipo():
    ...
    if tipo:
        ...
        try:
            ...
            print("Error al buscar dato en esclavo2", e)
